...
(function () {
    ...
    function twoColumnMenuGenerate() {
        ...
        if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
            ...
            ul.innerHTML = '<a href="#" class="logo"><img src="/assets/images/logo/logo-sm.png" alt="" height="22"></a>';
    ...
    function windowResizeHover() {
        ...
        if (windowSize < 1025 && windowSize > 767) {
            ...
            // santos: hapus agar tetap mengikuti state sebelumnya
        ...
        // santos: update icon agar mengikuti state sidebar
        if (sessionStorage.getItem("data-layout") == "vertical") {
    ...
    function toggleHamburgerMenu() {
        ...
        if (document.documentElement.getAttribute("data-layout") === "vertical") {
            if (windowSize <= 1025 && windowSize > 767) {
                document.body.classList.remove("vertical-sidebar-enable");
                // santos: update untuk mengikut state sebelumnya
                if(document.documentElement.getAttribute("data-sidebar-size") == "sm") {
                    document.documentElement.setAttribute("data-sidebar-size", "lg");
