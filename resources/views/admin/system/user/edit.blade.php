                            ...
                            <div class="tab-pane" :class="activeTab == 'umum' && 'active'" id="tabUmum"
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <x-admin::input.text :name="'password'"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <x-admin::input.select2id :id="'status'" :name="'status'"
                                                :options="\App\Utilities\SelectHelpers\System\SH_Status::common()" :placeholder="'- Pilih Status -'" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-uppercase text-center" style="width: 50px">
                                                            <x-admin::input.checkbox :name="'isCheckedAllCabang'"
                                                                :value="!$isCheckedAllCabang" :form-check-class="false"
                                                                :wire:key="'toggleCheckAllCabang'"
