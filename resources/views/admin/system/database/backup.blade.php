<div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <x-admin::includes.pages.browse-header
                    :create-button="false"
                    :export-excel="false"
                    :pagination="false"
                >
                    <span class="btn btn-primary btn-load" wire:click="processBackup">
                                ...
                                >
                                    <li>
                                        <span
                                            role="button"
                                            class="dropdown-item"
                                            wire:click="downloadFile('{{ $obj['disk'] }}', '{{ $obj['path'] }}')"
                                        >
                                            <i class="ri-download-2-fill align-bottom me-2 text-muted"></i>
                                            Download
                                        </span>
                                    </li>
                                    ...
                                    <li>
                                        <span
                                            role="button"
                                            class="dropdown-item"
                                            wire:click="deleteFile('{{ $obj['disk'] }}', '{{ $obj['path'] }}')"
                                        >
