                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="card-title">
                                    <strong>Data Retur Penjualan</strong>
                                </div>
                                <hr />
                        ...
                        <div class="mb-3">
                            <div class="row g-3">
                                <div class="col-md-3 col-12">
                                    <x-admin::input.select2id :id="'input_faktur_penjualan_id'" :name="'input_faktur_penjualan_id'" :options="\App\Utilities\SelectHelpers\Transaksi\Penjualan\SH_FakturPenjualan::belumLunas(
                                        $customer_id,
                                        is_show_sisa_piutang: false,
                                    )"
                                        :defer="false" placeholder="Pilih Faktur Penjualan" />
                                </div>
                                <div class="col-md-3 col-12">
                                    <x-admin::input.select2id :id="'input_faktur_penjualan_detail_id'" :name="'input_faktur_penjualan_detail_id'" :options="[]"
                                ...
                                <div class="col-md-3 col-12">
                                    <x-admin::input.readonly :value="_number($input_harga_satuan)" :name="'input_harga_satuan'"
                                        placeholder="Harga" />
                                </div>
                                <div class="col-md-3 col-12">
                                    <x-admin::input.readonly :value="_number($input_diskon_satuan)" :name="'input_diskon_satuan'"
