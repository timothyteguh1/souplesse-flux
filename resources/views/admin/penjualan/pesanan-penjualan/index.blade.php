            ...
            <div class="card">
                ...
                <x-admin::includes.pages.browse-filter>
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-3 col-sm-6">
                            <x-admin::input.select2 :name="'customer_id'" :options="\App\Utilities\SelectHelpers\Master\SH_Customer::active()" :placeholder="'- Semua Customer -'" />
                        </div>
                        <!--end col-->

                        <div class="col-xxl-3 col-sm-6">
                            <x-admin::input.select2 :name="'status'" :options="\App\Utilities\SelectHelpers\System\SH_Status::pesanan_penjualan()" :placeholder="'- Semua Status -'" />
                        </div>
                        <!--end col-->

                        <div class="col-xxl-3 col-sm-6">
                            <x-admin::input.select2 :name="'user_id'" :options="\App\Utilities\SelectHelpers\System\SH_User::active()" :placeholder="'- Semua User -'" />
                        </div>
                        <!--end col-->
                    ...
                    <x-slot name="head">
                        <tr>
                            ...
                            <x-admin::utils.th-sortable-cabang :label="'Cabang'" :field="'cabang_id'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" style="width: 180px" />
