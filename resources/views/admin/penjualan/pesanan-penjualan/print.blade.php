...
<x-admin::layouts.pdf :title="'Faktur Penjualan ' . $obj->kode">
    ...
    <div class="mb-10">
        <table class="valign-top">
            <tr>
                <td class="font-24"><strong>Pesanan Penjualan</strong></td>
            </tr>
            <tr>
                <td class="two-third">
                    ...
                    <table class="bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="15%">Diskon per Qty</th>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th class="text-right" colspan="6">Diskon Faktur
                                    ({{ _number($obj->diskon_persen) }}%)</th>
                                <th class="text-right">{{ _number($obj->diskon_rupiah) }}</th>
                            </tr>
                            <tr>
