<x-admin::layouts.pdf :title="'Faktur Penjualan Via SO ' . $obj->kode">
    <div class="mb-10">
            ...
            <tr>
                <td class="two-third">
                    <table class="table-spaced">
                        <tbody>
                            <tr>
                                <td class="font-24" colspan="2"><strong>Faktur Penjualan Via SO</strong></td>
                            </tr>
                            <tr>
                                <td>Kepada Yth.</td>
                            </tr>
    ...
    @if (count($obj->fakturPenjualanSets))
        <div>
            <table class="valign-top">
                <tr>
                    <td><strong>Rincian Set</strong></td>
                </tr>
                <tr>
                    <td style="width: 100%">
                        <table class="bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="30%">Satuan Produk</th>
                                    <th class="text-center" width="30%">Jumlah</th>
                                    <th class="text-center" width="30%">Grand Total</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($obj->fakturPenjualanSets()->get() as $detail)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $detail->satuan_teks }}</td>
                                        <td class="text-end">
                                            {{ _number($detail->jumlah) }}
                                        </td>
                                        <td class="text-end">
                                            {{ _number($detail->total) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    @if (count($obj->fakturPenjualanServices))
        <div>
            <table class="valign-top">
                <tr>
                    <td><strong>Rincian Service</strong></td>
                </tr>
                <tr>
                    <td style="width: 100%">
                        <table class="bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="20%">Grand Total</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($obj->details()->with(['produk', 'satuan'])->get() as $detail)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $detail->perintahService?->kode }}</td>
                                        <td>{{ $detail->perintahService?->customer?->nama }}</td>
                                        <td>{{ $detail->perintahService?->tanggal }}</td>
                                        <td class="text-end">
                                            {{ _number($detail->perintahService?->totalBiayaService) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <tbody>
                <tr>
                    ...
                    <th class="col-6 text-end">
                        {{ _number($obj->total_produk) }}
                    </th>
                </tr>
                <tr>
                    <th class="col-4">Total Set</th>
                    <th class="col-6 text-end">
                        {{ _number($obj->total_set) }}
                    </th>
                </tr>
                <tr>
                    <th class="col-4">Total Service</th>
                    <th class="col-6 text-end">
                        {{ _number($obj->total_service) }}
                    </th>
                </tr>
                <tr>
