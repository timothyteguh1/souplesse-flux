...
<div>
        ...
        <div class="col-12">
            <form wire:submit="submitDefault">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="card-title"><strong>Data Faktur Penjualan</strong></div>
                                <hr />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <x-admin::input.select2id :id="'jenis_transaksi'" :name="'jenis_transaksi'"
                                            :options="\App\Utilities\SelectHelpers\SH_Umum::jenisTransaksiFakturPenjualan()" placeholder="- Pilih Jenis Transaksi -"
                                            :defer="false" :allow-clear="false" />
                                    </div>
                                </div>

                                @if ($jenis_transaksi == \App\Utilities\Constants\Const_Umum::JENIS_TRANSAKSI_FAKTUR_PENJUALAN_KREDIT)
                                    <div class="row mb-3">
                                        <label class="col-lg-3 col-form-label">
                                            Jatuh Tempo
                                            <span class="text-danger">*</span>
                                                ...
                                                <table class="table table-bordered align-middle table-nowrap mb-0">
                                                    <thead class="table-light text-uppercase">
                                                        <tr>
                                                            ...
                                                            <th width="15%" class="text-end" colspan="2">Diskon
                                                            </th>
                                                            <th width="15%" class="text-end">Detail Diskon</th>
                                                            <th width="10%" class="text-end">Subtotal</th>
                                                            <th width="10%" class="text-end">Action
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                    ...
                    @elseif ($jenis_transaksi == \App\Utilities\Constants\Const_Umum::JENIS_TRANSAKSI_FAKTUR_PENJUALAN_LUNAS)
                        <div class="card-footer text-end">
                            <span class="btn btn-primary" role="button" tabindex="0" wire:click="openModalBayar"
                                wire:keydown.enter="openModalBayar">
                                <i class="ri- align-bottom me-1"></i>
                                Bayar
                            </span>
                        </div>
    ...
    <x-admin::utils.modal-dialog :id="'ModalListPromo'">
        <livewire:admin.penjualan.faktur-penjualan.modal-list-promo />
    </x-admin::utils.modal-dialog>

    <x-admin::utils.modal-dialog :id="'ModalPembayaranEdit'">
        <livewire:admin.penjualan.faktur-penjualan.modal-pembayaran-edit />
    </x-admin::utils.modal-dialog>
</div>
