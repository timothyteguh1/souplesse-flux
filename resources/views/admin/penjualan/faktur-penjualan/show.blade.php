...
<div>
    ...
    <div class="row">
        <div class="col-12">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ $obj->gudang?->getRouteShow() }}">
                            {{ $obj->gudang?->kode }} &mdash; {{ $obj->gudang?->nama }}
                        </a>
                    </td>
                </tr>
                <tr>
                    <th>Alamat &mdash; Jalan</th>
                    <td>{!! nl2br(e($obj->customer->alamat)) !!}</td>
                </tr>
                <tr>
                    <th>Alamat &mdash; Kota</th>
                    <td>{{ $obj->customer->kota }}</td>
                </tr>
                <tr>
                    <th>Alamat &mdash; Kode Pos</th>
                    <td>{{ $obj->customer->kode_pos }}</td>
                </tr>
                <tr>
                    <th>Alamat &mdash; Provinsi</th>
                    <td>{{ $obj->customer->provinsi }}</td>
                </tr>
                <tr>
                    <th>Kelas Customer</th>
                    <td>{{ $obj->customer?->kelasCustomer?->nama }}</td>
                </tr>
                <tr>
                    <th>Keterangan</th>
                                    ...
                                    <table class="table table-bordered align-middle">
                                        <thead>
                                            <tr class="text-uppercase bg-light">
                                                ...
                                                <th width="10%" class="text-center" colspan="2">Diskon</th>
                                                <th width="10%">Detail Diskon</th>
                                                @if ($obj->customer?->kelasCustomer?->nama == 'GROSIR')
                                                    <th width="10%">Diskon Grosir?</th>
                                                @endif
                                        ...
                                        <tbody>
                                            @foreach ($obj->details()->with(['produk', 'satuan'])->get() as $detail)
                                                <tr>
                                                    ...
                                                    @if ($obj->customer?->kelasCustomer?->nama == 'GROSIR')
                                                        <td>
                                                            {{ $detail->is_promo_grosir_applied ? 'Ya' : 'Tidak' }}
                                                        </td>
                                                    @endif
                                                    <td class="text-end">
            ...
            @if ($obj->jenis_transaksi == App\Utilities\Constants\Const_Umum::JENIS_TRANSAKSI_FAKTUR_PENJUALAN_LUNAS)
                <div class="card">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center">
