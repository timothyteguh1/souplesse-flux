<x-admin::layouts.pdf :title="'Penyesuaian Kurang ' . $obj->kode">
    <div class="mb-10">
    ...
    <div class="mb-10">
        <table class="valign-top">
            <tr>
                <td class="font-20"><strong>PENYESUAIAN KURANG</strong></td>
            </tr>
            <tr>
                <td class="one-third">
        ...
        <table class="bordered">
            <thead>
                <tr>
                    ...
                    <th width="15%" class="text-right">Qty Kurang</th>
            ...
            <tfoot>
                <tr>
                    <th class="text-right" colspan="4">Total Nilai Persediaan yang Berkurang</th>
                    <th class="text-right">
