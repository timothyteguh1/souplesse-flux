<div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <x-admin::includes.pages.browse-header :model="$model" :createButton="false" />
                    ...
                    <x-slot name="head">
                        <tr>
                            ...
                            <x-admin::utils.th-sortable :label="'Kota'" :field="'kota'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Telp'" :field="'telp'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Email'" :field="'email'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
