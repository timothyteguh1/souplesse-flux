                ...
                <x-admin::includes.pages.browse-table :data="$data">
                    <x-slot name="head">
                        <tr>
                            ...
                            <x-admin::utils.th-sortable-cabang :label="'Cabang'" :field="'cabang_id'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Kode Promo'" :field="'kode'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Produk'" :field="'produk_id'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Pembelian Minimum'" :field="'jumlah_minimum'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                            <x-admin::utils.th-sortable :label="'Tambahan Diskon (%)'" :field="'tambahan_diskon'" :sort-field="$sortField"
                                :sort-asc="$sortAsc" />
                    ...
                    @foreach ($data as $obj)
                        <tr>
                            ...
                            <td>
                                <a href="{{ $obj->produk->getRouteShow() }}">{{ $obj->produk->nama }}</a>
                            </td>
                            <td>
                                {{ _number($obj->jumlah_minimum) }}
                            </td>
                            <td>
                                {{ _number($obj->tambahan_diskon) }}
                            </td>
                            <td>{{ $obj->status }}</td>
