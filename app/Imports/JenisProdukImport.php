...
class JenisProdukImport implements ToArray, WithHeadingRow, WithCalculatedFormulas, WithValidation
{
    use Importable;
    ...
    public function array(array $array)
    {
        ...
        foreach ($array as $row) {
            ...
            if (!JenisProduk::where('nama', $row['nama'])->exists()) {
                JenisProdukService::create($row);
            }
