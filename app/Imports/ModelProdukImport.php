...
class ModelProdukImport implements ToArray, WithHeadingRow, WithCalculatedFormulas, WithValidation
{
    use Importable;
    ...
    public function array(array $array)
    {
        ...
        foreach ($array as $row) {
            ...
            if (!ModelProduk::where('nama', $row['nama'])->exists()) {
                ModelProdukService::create($row);
            }
