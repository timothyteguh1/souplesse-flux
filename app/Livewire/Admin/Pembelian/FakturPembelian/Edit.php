...
class Edit extends Component
{
    ...
    public function mount()
    {
        ...
        $this->kode_faktur_supplier = $this->obj->kode_faktur_supplier;
        ...
        $this->grandtotal = $this->obj->grandtotal;
        ...
        $details = $this->obj->fakturPembelianBebans()->with(['beban'])->get();
        $this->items_beban = [];
    ...
    {
        return SH_Produk::activeSupplier(
            $this->supplier_id,
        );
    }
    ...
    {
        FakturPembelianService::update($this->obj, $validated);
    ...
    public function render()
    {
        ...
        return view('admin.pembelian.faktur-pembelian.edit')
            ->layout($this->layout);
    }
}
