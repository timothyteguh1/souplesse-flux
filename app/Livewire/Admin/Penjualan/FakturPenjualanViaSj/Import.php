...
class Import extends Component
{
    ...
    protected $template_view = 'admin.penjualan.faktur-penjualan-via-sj.import-template';
    public $cabang_id;
    public $ekspedisi_id;
    public $gudang_id;
    public $file;
    ...
    {
        return view('admin.penjualan.faktur-penjualan-via-sj.import')->layout($this->layout);
    }
}
