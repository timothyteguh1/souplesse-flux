...
class ModalSet extends Component
{
    use WithModalForm;
    ...
    public function refreshInfo($params)
    {
        ...
        if ($this->index_modal_set !== null) {
            $this->gudang_id = $params['items']['gudang_id'];
    ...
    {
        $this->reset('items', 'input_set_produk_id', 'input_set_satuan_id', 'input_set_jumlah', 'input_set_harga_satuan', 'input_set_diskon_satuan_type', 'input_set_diskon_satuan');
        $this->refreshInputSetProdukId();
    }

    public function refreshInputSetProdukId()
    {
    ...
    public function render()
    {
        ...
        return view('admin.penjualan.faktur-penjualan-via-sj.modal-set');
    }
}
