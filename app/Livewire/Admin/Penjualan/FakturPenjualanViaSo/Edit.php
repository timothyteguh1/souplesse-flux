...
class Edit extends Component
{
    ...
    {
        return SH_PesananPenjualan::belumDifakturkan([$this->pesanan_penjualan_id]);
    }
    ...
    {
        return SH_Umum::jenisTransaksiFakturPenjualan();
    }
    ...
    public function updatedPesananPenjualanId()
    {
        ...
        if ($this->pesanan_penjualan_id) {
            ...
            $pesananPenjualan = PesananPenjualan::find($this->pesanan_penjualan_id);
            $customer = $pesananPenjualan->customer;
            ...
            $pesananPenjualanDetail = $pesananPenjualan->details()->with(['produk', 'satuan'])->get();
            foreach ($pesananPenjualanDetail as $detail) {
    ...
    public function render()
    {
        ...
        return view('admin.penjualan.faktur-penjualan-via-so.edit')
            ->layout($this->layout);
    }
}
