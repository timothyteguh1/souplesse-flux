...
class Index extends Component
{
    ...
    protected $page_permissions = ['admin.penjualan.faktur-penjualan-via-so.index'];
    protected $export_filename = 'faktur_penjualan_via_so';
    protected $export_orientation = Const_Umum::ORIENTATION_PORTRAIT;
    protected $export_view = 'admin.penjualan.faktur-penjualan-via-so.index-export';
    public $tanggal;
    public $keyword;
    public $customer_id;
    public $gudang_id;
    ...
    public function mount()
    {
        ...
        $this->jenis_transaksis = [Const_JenisTransaksi::FAKTUR_PENJUALAN_VIA_SO];
    }
    ...
    public function render()
    {
        ...
        return view('admin.penjualan.faktur-penjualan-via-so.index', [
            'data' => $this->data,
        ])->layout($this->layout);
    }
}
