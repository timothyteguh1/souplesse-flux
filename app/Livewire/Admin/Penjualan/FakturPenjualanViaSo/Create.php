...
class Create extends Component
{
    ...
    protected $page_permissions = ['admin.penjualan.faktur-penjualan-via-so.create'];
    public $cabang_id;
    public $kode;
    public $jenis_transaksi = Const_Umum::JENIS_TRANSAKSI_FAKTUR_PENJUALAN_SO;
    ...
    public function render()
    {
        ...
        return view('admin.penjualan.faktur-penjualan-via-so.create')->layout($this->layout);
    }
}
