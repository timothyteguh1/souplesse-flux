...
namespace App\Livewire\Admin\Laporan\Keuangan\KartuUtang;
...
class Index extends Component
{
    ...
    public $menuTitle = 'Kartu Utang';
    protected $export_filename = 'laporan_kartu_utang';
    protected $export_orientation = Const_Umum::ORIENTATION_LANDSCAPE;
    protected $export_view = 'admin.laporan.keuangan.kartu-utang.index-export';
    ...
    {
        abort_if(Gate::none(['admin.laporan.keuangan.kartu-utang']), Response::HTTP_FORBIDDEN);
    ...
    {
        return view('admin.laporan.keuangan.kartu-utang.index', $this->data)->layout($this->layout);
    }
}
