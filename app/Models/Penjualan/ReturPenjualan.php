...
class ReturPenjualan extends Model
{
    ...
    protected $route_prefix = 'admin.penjualan.retur-penjualan';
    protected $permission_prefix = 'admin.penjualan.retur-penjualan';
    protected $fillable = [
        'cabang_id',
        'kode',
        'tanggal',
    ...
    protected $attributes = [
        'status' => Const_Status::RETUR_PENJUALAN_BELUM_LUNAS,
    ];
    protected $casts = [
