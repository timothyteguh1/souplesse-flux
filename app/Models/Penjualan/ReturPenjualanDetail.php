...
class ReturPenjualanDetail extends Model
{
    ...
    protected $fillable = [
        'retur_penjualan_id', 'faktur_penjualan_detail_id', 'produk_id', 'satuan_id', 'jumlah', 'harga_satuan', 'diskon_satuan_type', 'diskon_satuan', 'keterangan',
    ];
    ...
    public function fakturPenjualanDetail(): BelongsTo
    {
        return $this->belongsTo(FakturPenjualanDetail::class);
    }
